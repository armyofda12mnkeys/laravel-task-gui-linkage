...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
		...
		if (Schema::hasTable('batch_processes')) {//only run if table exist, need to check this otherwise 'php artisan migrate' will complain the table doesn't exist when it runs since it also bootstraps/runs Kernel.php it seems
			//*
		...
		//example of a normal non-dynamic/static registration of a task.
